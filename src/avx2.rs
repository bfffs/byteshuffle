    ...
    dst: *mut u8)
{
    ...
    for j in (0..16).step_by(4) {
        ...
        //   * extend to __m126i with _mm256_castsi128_si256
        //   * Use i32 shuffles or shifts plus blends to get four registers that look like
        //     - 0000000000000000
        //     - 1111111111111111
        //     - 2222222222222222
        //     - 3333333333333333
        ...
        for k in 0..4 {
            ...
            eprintln!("load from {}", (i * 16 * TS + j + 4 * TS * k) as f64 / 4.);
        ...
        for k in 0..4 {
            ...
            eprintln!("store to {}", ((i + (j + k) * vectorizable_elements / 16) * TS) as f64 / 4.);
